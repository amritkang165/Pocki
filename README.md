...
| 📋 **History import** | Drop a **transaction-history** screenshot → **auto-detected** → every row becomes an editable expense → **failed** ones land in their own column (excluded from save) → save all at once |
| 🎯 **Monthly budget** | Set a budget · live ring on Home · remaining · daily average · **browse past months** |
...
```text
  ┌─ HOME ─────────────────────────────────────────────┐
  │  greeting · animated budget ring · month switching │
  ...
  │  screenshot → OCR, auto-detects single vs history  │
  │  history opens one full-screen review → save       │
  └────────────────────────────────────────────────────┘
            │
  ┌─ INSIGHTS ─────────────────────────────────────────┐
